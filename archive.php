<?php get_header(); ?>
  ...
  <div class="container">
    <h1>Blog</h1>
    <p class="lead"><?php echo the_category(','); ?><!--#GrinUGR, proyectos de investigación que usan internet como herramienta.--></p>
  </div>
</div>
				...
				<div id="main" class="span8 blog-col-izquierda clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<p class="meta"><?php _e("Publicado el", "bonestheme"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time('j M, Y'); ?></time> <?php _e("por", "bonestheme"); ?> <?php the_author_posts_link(); ?> <span class="amp"></span> <?php _e("en", "bonestheme"); ?> <?php the_category(', '); ?>.</p>
						...
						<section class="post_content clearfix">
							...
							<?php the_excerpt(); ?>
							 <a href="<?php the_permalink() ?>" class="btn btn-inverse btn-small pull-right" >Leer más</a>
