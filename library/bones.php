...
function bones_footer_links($nombre) { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		'menu' => $nombre, /* menu name */
    		'theme_location' => '', /* where in the theme it's assigned */
    		'container_class' => 'menu-mas-info-menu-container', /* container class */
...
function page_navi($before = '', $after = '') {
	...
	$prueba=__("<!--:en-->&larr; Previous<!--:--><!--:es-->&larr; Anteriores<!--:-->");
	$prevposts = get_previous_posts_link($prueba);
	if($prevposts) { echo '<li>' . $prevposts  . '</li>'; }
	else { 
		echo '<li class="disabled"><a href="#">&larr;';?>
		<?php _e("<!--:en-->Previous<!--:--><!--:es-->Anteriores <!--:-->"); ?>
		<?php echo'</a></li>'; 
	}
	...
	echo '<li class="">';
	$prueba=__("<!--:en-->Next &rarr; <!--:--><!--:es-->Siguientes &rarr;<!--:-->");
	next_posts_link($prueba);
	echo '</li>';
	if ($end_page < $max_page) {
