<?php get_header(); ?>
  ...
  <div class="container-fluid home-container">
    <h1><?php _e("<!--:en-->Media Library<!--:--><!--:es-->Biblioteca de Medios<!--:-->"); ?><?php /*the_title();*/ ?></h1>
	
	<p class="lead"><?php _e("<!--:en-->Videos,books,photos and other resources<!--:--><!--:es-->Vídeos, libros, fotos y otros recursos.<!--:-->"); ?></p>
								...
								<div class="media span4">
								 ...
								 <?php }else{ ?>
								  ...
								  <div class="media-body">
									<h4 class="media-heading"><span class="muted"><?php 
									if(count($media_types)>0){
											foreach($media_types as $media_type){
												if(strcmp($media_type->name,"Galerías")==0){
													_e("<!--:en-->Gallery<!--:--><!--:es-->Galería<!--:-->");
												}
												if(strcmp($media_type->name,"Videos")==0){
													_e("<!--:en-->Video<!--:--><!--:es-->Video<!--:-->");
												}
												if(strcmp($media_type->name,"Libros")==0){
													_e("<!--:en-->Book<!--:--><!--:es-->Libro<!--:-->");
												}										
									...
									<a href="<?php the_permalink() ?>" class="btn btn-small btn-inverse"><?php _e("<!--:en-->View more<!--:--><!--:es-->Ver más<!--:-->"); ?></a></p>
								  </div>
