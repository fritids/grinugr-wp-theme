<?php get_header(); ?>
  ...
  <div class="container-fluid home-container">
      <h1><img class="entidad-icon" src="<?php bloginfo('template_url') ?>/images/icons/icon-proyectosgrinugr-large.png" alt="imagen de proyectos" width="60" /> <?php _e("<!--:en-->Projects GRINUGR<!--:--><!--:es-->Proyectos GRINUGR <!--:-->"); ?><?php /*the_title();*/ ?></h1>
