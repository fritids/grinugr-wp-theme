...
<div id="overview" class="jumbotron subhead">
  <div class="container">
	...
	<?php if(qtrans_getLanguage()=='en'){ ?>
		<a href="/en/centros/" title="Volver al listado de Centros"><img class="entidad-icon" src="<?php bloginfo('template_url') ?>/images/icons/icon-centros-large.png" alt="imagen de centros" width="60" />Centers<?php /*the_title();*/ ?></a></h1>
	<?php } ?>
	<?php if(qtrans_getLanguage()=='es') { ?>								
		<a href="/centros/" title="Volver al listado de Centros"><img class="entidad-icon" src="<?php bloginfo('template_url') ?>/images/icons/icon-centros-large.png" alt="imagen de centros" width="60" />Centros  <?php /*the_title();*/ ?></a></h1>
	<?php } ?>	
  ...
  <div class="container">
				...
				<div id="main" class="span8 blog-col-izquierda clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header>
							...
							<!--<div id="custom-bg" style="width:<?=$image[1]?>px; max-width:100%; max-height:400px; height:<?=$image[2]?>px; background-position:top;background-image: url('<?php echo $image[0]; ?>'); background-size:cover;">-->
	...
	<?php endif; ?>
				...
				<div class="content-fluid">
					<h3 class="titulo-right-content"><i class="icon-birrete-big"></i><?php _e("<!--:en-->OTHER CENTERS IN<!--:--><!--:es-->OTROS CENTROS EN EL <!--:-->"); ?> <span class="green"><?php _e("<!--:en-->DIGITAL<!--:--><!--:es-->BANCO <!--:-->"); ?></span> <?php _e("<!--:en-->BANK<!--:--><!--:es-->DIGITAL <!--:-->"); ?>
					<?php if(qtrans_getLanguage()=='en'){ ?>
						<a class="ver-todas-lnk" href="/en/centros/">See all&raquo;</a></h3>
					<?php } ?>
					<?php if(qtrans_getLanguage()=='es') { ?>								
						<a class="ver-todas-lnk" href="/centros/">Ver todos&raquo;</a></h3>
					<?php } ?>	
					...
					<div class="destacados-grinugr">
						...
						$centros=get_destacados_grinugr('centros');
