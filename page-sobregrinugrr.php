<?php
/*
Template Name: Sobre el Proyecto GrinUGR e hijas
*/
?>
...
<div id="overview" class="jumbotron subhead">
  <div class="container">
	...
	?>
    <p class="lead"><?php _e("<!--:en-->Group learning and interdisciplinary research that aims to exchange experiences and ideas related to the use of Internet.<!--:--><!--:es-->Grupo de aprendizaje e investigación interdisciplinar que tiene por objetivo el intercambio de experiencias e ideas, vinculadas al empleo de Internet.<!--:-->"); ?></p>
	<!--<?=$subtitulo?>-->
  </div>
</div>
<div class="bs-docs-social">
  <div class="container">
    ...
    <?php endwhile; ?>
	<?php endif; ?>
				<?php get_sidebar('pagegrinugr'); // sidebar 2 ?>
