<?php get_header(); ?>
  ...
  <div class="container-fluid home-container">
    <h1><?php _e("<!--:en-->References in Media<!--:--><!--:es-->Referencias en Medios<!--:-->"); ?><?php /*the_title();*/ ?></h1>
	
	<p class="lead"><?php _e("<!--:en-->GrinUGR Mentions in the media.<!--:--><!--:es-->Menciones a GrinUGR en los medios de comunicación.<!--:-->"); ?></p>
				...
				<div id="main" class="blog-col-izquierda clearfix" role="main">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
								...
								<div class="media span4">
								 ...
								 <?php }else{ ?>
								   <a href="<?php the_permalink() ?>" class="img-circle custom-post-thumb pull-left" style="background-image:url('<?php bloginfo('template_url'); ?>/images/no_pic_referencia.jpg');">
									<!--<img data-src="holder.js/120x120" class="img-circle" alt="120x120" style="width: 120px; height: 120px;" src="<?php echo $image[0]; ?>">-->
								  ...
								  <?php } ?>
								  <?php
									 $media_types=get_terms( "formatos" );
									 
								  ?>
								  <div class="media-body">
									<h4><span class="muted"><?php _e("<!--:en-->Reference<!--:--><!--:es-->Referencia<!--:-->"); ?></span><span class="real-muted pull-right"><time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time('j M, Y'); ?></time></span></h4>
