<?php get_header(); ?>
  ...
  <div class="container-fluid home-container">
    <h1><img class="entidad-icon" src="<?php bloginfo('template_url') ?>/images/icons/icon-proyectos-large.png" alt="imagen de proyectos" width="60" /> <?php _e("<!--:en-->Digital Projects<!--:--><!--:es-->Proyectos Digitales <!--:-->"); ?><?php /*the_title();*/ ?></h1>
				...
				<div id="main" class="blog-col-izquierda clearfix" role="main">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
								...
								<div class="media span4">
								 ...
								 <?php }else{ ?>
								   <a href="<?php the_permalink() ?>" class="img-circle custom-post-thumb pull-left" style="background-image:url('<?php bloginfo('template_url'); ?>/images/no_pic_proyecto.jpg');">
									<!--<img data-src="holder.js/120x120" class="img-circle" alt="120x120" style="width: 120px; height: 120px;" src="<?php echo $image[0]; ?>">-->
