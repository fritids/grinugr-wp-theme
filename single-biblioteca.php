...
<div id="overview" class="jumbotron subhead">
  <div class="container">
    <h1><?php _e("<!--:en-->Media Library<!--:--><!--:es-->Biblioteca de Medios<!--:-->"); ?></h1>
    <p class="lead"><?php the_category($post_id); ?><!--#GrinUGR, proyectos de investigación que usan internet como herramienta.--></p>
  </div>
</div>
				...
				<div id="main" class="span8 blog-col-izquierda clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header>
							...
							<p class="meta pull-left"><?php _e("<!--:en-->Posted in<!--:--><!--:es-->Pûblicado el <!--:-->", "bonestheme"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time('j M, Y'); ?></time> <?php/* _e("por", "bonestheme"); ?> <?php the_author_posts_link();*/ ?> <span class="amp"></span> <?php _e("<!--:en-->in<!--:--><!--:es-->en <!--:-->", "bonestheme"); ?> <?php the_category(', '); ?>.</p>
