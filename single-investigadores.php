...
<div id="overview" class="jumbotron subhead">
  <div class="container">
	...
	<?php if(qtrans_getLanguage()=='en'){ ?>
		<a href="/en/investigadores/" title="Volver al listado de Investigadores">
	<?php } ?>
	<?php if(qtrans_getLanguage()=='es') { ?>								
		<a href="/investigadores/" title="Volver al listado de Investigadores">
	<?php } ?>	
	
	<img class="entidad-icon" src="<?php bloginfo('template_url') ?>/images/icons/icon-investigadores-large.png" alt="imagen de investigadores" width="60" /> <?php _e("<!--:en-->Researchers<!--:--><!--:es-->Investigadores <!--:-->"); ?><?php /*the_title();*/ ?></a></h1>
	
	<p class="lead"><?php _e("<!--:en-->Researchers who use the internet as a tool.<!--:--><!--:es-->Investigadores que emplean internet como herramienta. <!--:-->"); ?></p>
  </div>
</div>
  ...
  <div class="container">
				...
				<div id="main" class="span8 blog-col-izquierda clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header>
							...
							<div id="custom-bg" style="width:<?=$image[1]?>px; max-width:97%; max-height:400px; height:<?=$image[2]?>px; background-position:top;background-image: url('<?php echo $image[0]; ?>'); background-size:cover;">
					...
					<h4><?php _e("<!--:en-->Are you a researcher or belong to this entity?<!--:--><!--:es-->¿Eres un investigador o perteneces a esta entidad? <!--:-->"); ?> </h4> <?php _e("<!--:en-->If there is any data you want to change, enter it below as a comment.<!--:--><!--:es-->Si hay algún dato que desees modificar, indícalo a continuación como comentario. <!--:-->"); ?>
					</div>
	...
	<?php endif; ?>
				...
				<div class="content-fluid">
					<h3 class="titulo-right-content"><i class="icon-birrete-big"></i><?php _e("<!--:en-->OTHER RESEARCHERS IN<!--:--><!--:es-->OTROS INVESTIGADORES EN EL <!--:-->"); ?> <span class="green"><?php _e("<!--:en-->DIGITAL<!--:--><!--:es-->BANCO <!--:-->"); ?></span> <?php _e("<!--:en-->BANK<!--:--><!--:es-->DIGITAL <!--:-->"); ?>
					<?php if(qtrans_getLanguage()=='en'){ ?>
					...
					<div class="destacados-grinugr">
						...
						$investigadores=get_destacados_grinugr('investigadores');
						...
						foreach ($investigadores as $investigador) {
							$i++;
							$custom_post = get_post( $investigador );
