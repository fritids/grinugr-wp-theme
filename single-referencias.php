...
<div id="overview" class="jumbotron subhead">
  <div class="container">
    <h1><?php _e("<!--:en-->References in Media<!--:--><!--:es-->Referencias en Medios <!--:-->"); ?></h1>
				...
				<div id="main" class="span8 blog-col-izquierda clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header>
							...
							<p class="meta pull-left"><?php _e("<!--:en-->Posted in<!--:--><!--:es-->Publicado el <!--:-->", "bonestheme"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time('j M, Y'); ?></time> <?php/* _e("por", "bonestheme"); ?> <?php the_author_posts_link();*/ ?> <span class="amp"></span> <?php _e("<!--:en-->in<!--:--><!--:es-->en <!--:-->", "bonestheme"); ?> 
							<?php if(qtrans_getLanguage()=='en'){ ?>
								<a href="/en/referencias/">References </a></p>
							<?php } ?>
