<?php get_header(); ?>
  ...
  <div class="container-fluid home-container">
    <h1>Biblioteca de Medios<?php /*the_title();*/ ?></h1>
	
	<p class="lead">Vídeos, libros, fotos y otros recursos.</p>
								...
								<div class="media span4">
								 ...
								 <?php }else{ ?>
								  ...
								  <div class="media-body">
									...
									<a href="<?php the_permalink() ?>" class="btn btn-small btn-inverse">Ver más</a></p>
								  </div>
