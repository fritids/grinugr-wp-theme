<?php get_header(); ?>
  ...
  <div class="container-fluid home-container">
    <h1><img class="entidad-icon" src="<?php bloginfo('template_url') ?>/images/icons/icon-investigadores-large.png" alt="imagen de investigadores" width="60" /> <?php _e("<!--:en-->Researchers<!--:--><!--:es-->Investigadores <!--:-->"); ?><?php /*the_title();*/ ?></h1>
	
	<p class="lead"><?php _e("<!--:en-->Researchers who use internet as a tool.<!--:--><!--:es-->Investigadores que emplean internet como herramienta. <!--:-->"); ?></p>
	<?php if(qtrans_getLanguage()=='en'){ ?>
		<a href="/en/identificacion-de-proyectos-digitales/" class="btn btn-inverse btn-medium"><i class="icon-pencil icon-white"></i><strong>Add your case filling our form</strong></a>
				...
				<div id="main" class="blog-col-izquierda clearfix" role="main">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
								...
								<div class="media span4">
								  ...
								  <?php }else{ ?>
								   <a href="<?php the_permalink() ?>" class="img-circle custom-post-thumb pull-left" style="background-image:url('<?php bloginfo('template_url'); ?>/images/no_pic_inv.jpg');">
									<!--<img data-src="holder.js/120x120" class="img-circle" alt="120x120" style="width: 120px; height: 120px;" src="<?php echo $image[0]; ?>">-->
